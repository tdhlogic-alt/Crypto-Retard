...
data class BotProperties(
    ...
    val level2RotationEnabled: Boolean = true,
    ...
    val oversoldBounceMaxPriceTo24hLowPercent: BigDecimal = BigDecimal("103.0"),
    val breakoutMinTrend7dPercent: BigDecimal = BigDecimal("5.0"),
    val breakoutMinTrend24hPercent: BigDecimal = BigDecimal("1.5"),
    val breakoutMinPriceTo24hHighPercent: BigDecimal = BigDecimal("98.0"),
    val breakoutMaxRsi: BigDecimal = BigDecimal("72"),
    val momentumMinTrend1hPercent: BigDecimal = BigDecimal("0.4"),
    val momentumMinTrend4hPercent: BigDecimal = BigDecimal("1.0"),
    val momentumMinTrend24hPercent: BigDecimal = BigDecimal("2.0"),
    val momentumMaxRsi: BigDecimal = BigDecimal("75"),
    val rotationMaxFundingPnlPercent: BigDecimal = BigDecimal("2.0"),
    ...
    val strategyHighConvictionQuoteSizeUsd: BigDecimal = BigDecimal("25.00"),
    val strategyHighConvictionMinScore: Int = 90,
    val strategyPerformanceMinSample: Long = 5,
